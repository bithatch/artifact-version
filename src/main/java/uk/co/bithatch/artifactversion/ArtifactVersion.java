package uk.co.bithatch.artifactversion;
...
public class ArtifactVersion {
	...
	public static VersionDetails getVersionDetails(String installerShortName, String groupId, String artifactId) {
		String fakeVersion = Boolean.getBoolean("av.development")
				? System.getProperty("av.development.version", System.getProperty("av.devVersion"))
				: null;
		
		String fakeBuildDate = Boolean.getBoolean("av.development")
				? System.getProperty("av.development.buildDate", System.getProperty("av.devBuildDate", DateFormat.getDateInstance(DateFormat.SHORT).format(new Date())))
				: null;
